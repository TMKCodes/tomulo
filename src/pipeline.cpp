...
namespace Tomulo {
    Pipeline::Pipeline(Tomulo::Device* device, Tomulo::Renderpass* renderpass) : device{device}, renderpass{renderpass} {
        ...
        // Needs to be modified when loading vertex data.
        ...
        // Topology to TRIANGLE_STRIP and primitiveRestartEnabled to true to reuse triangle vertices
        VkPipelineInputAssemblyStateCreateInfo inputAssembly{};
        inputAssembly.sType = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO;
        inputAssembly.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
        inputAssembly.primitiveRestartEnable = VK_FALSE;

        // Specify dynamic viewport and scissor count
